...
/*  Clock configuration                                                */
/*                                                                     */
/*  TODO: replace this stub with the real SystemClock_Config()         */
/*  generated by CubeMX for your .ioc file.  The stub below is a      */
/*  safe default that runs at the HSI16 internal oscillator (16 MHz).  */
/*  Your CubeMX version will configure the PLL for 170 MHz.           */
/* ================================================================== */
static void SystemClock_Config(void)
{
